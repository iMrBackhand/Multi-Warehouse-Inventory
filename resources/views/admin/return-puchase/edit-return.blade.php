                ...
                <div class="container-fluid my-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                           ...
                           <form action="{{ route('return.purchase.update' ,$editData->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="col-xl-12">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input
                                                        ...
                                                        name="purchase_date"
                                                        class="form-control"
                                                        value="{{ old('purchase_date', \Carbon\Carbon::parse($editData->purchase_date)->format('Y-m-d')) }}">
                                                        ...
                                                        <div class="form-group w-100">
                                                            ...
                                                            <select name="supplier_id" id="supplier_id" class="form-control form-select" disabled>
                                                                ...
                                                                @foreach ($suppliers as $supplier)
                                                                    <option value="{{ $supplier->id }}" {{ $editData->supplier_id ==$supplier->id ? 'selected' : ''}} >
                                       ...
                                       <div class="table-responsive">
                                            <table id="purchaseTable" class="table table-striped table-bordered w-100">
                                                <thead>
                                                    ...
                                                    <tbody>
                                                @forelse ($editData->returnPurchaseItems as $item)
                                                            ...
                                                            <div class="card-body pt-3">
                                                                ...
                                                                <table class="table border">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>Discount:</td>
                                                                            <td id="displayDiscount">Php {{ $editData->discount }}</td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>Shipping:</td>
                                                                            <td id="shippingDisplay">Php {{ $editData->shipping }}</td>
                                                                        </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-primary">
                                                                        <span id="grandTotal">Php {{ $editData->grand_total }}</span>
                                                                        <input
                                                                            type="hidden"
                                                                            id="grandTotalInput"
                                                                            name="grand_total"
                                      ...
                                      <select name="status" id="status" class="form-control form-select" required>
                                        ...
                                        <option value="Approved"
                                            {{ old('status', $editData->status) == 'Approved' ? 'selected' : '' }}>
                                            Approved
                                        </option>

                                        <option value="Returned"
                                            {{ old('status', $editData->status) == 'Returned' ? 'selected' : '' }}>
                                            Returned
                                        </option>

                                        <option value="Cancelled"
                                            {{ old('status', $editData->status) == 'Cancelled' ? 'selected' : '' }}>
                                            Cancelled
                                        </option>
                                    </select>
                                ...
                                <div class="col-xl-12">
                                    <div class="d-flex justify-content-end gap-2 mt-4">
                                        ...
                                        <a href="{{ route('return.purchase') }}" class="btn btn-sm btn-secondary">
                                            Cancel
                                        </a>
