...
<div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            ...
            <div class="text-end">
                <a href="{{ route('all.review') }}" class="btn btn-sm text-white" style="background-color:#6c757d;">
                        Back
                </a>
            </div>
        </div>
                          ...
                          <td>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                          ...
                                          <form action="{{ route('restore.review',$review->id) }}" method="POST" style="display: inline">
                                                @csrf
                                                @method('PUT')
