                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold fs-16">{{ $purchase->purchaseItems->count() }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white d-flex align-items-center gap-2">
                            ...
                            <h5 class="mb-0 fs-15 fw-semibold">Purchase Information</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <th class="text-muted fw-normal" width="45%">Purchase ID</th>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="mb-0 fs-15 fw-semibold">Purchased Items</h5>
                            </div>
                                    ...
                                    <tfoot>
                                        <tr class="table-light">
                                            ...
                                            <th class="text-end pe-3 text-success fs-16">
                                                ₱ {{ number_format($purchase->purchaseItems->sum('subtotal'),2) }}
                                            </th>
                                        </tr>
                                    </tfoot>
                                    @endif
        ...
        <table class="print-only" style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="vertical-align:bottom;">
                                ...
                                <div style="color:#666; font-size:12px;">Purchase Order Receipt</div>
                            </td>
                            <td style="text-align:right; vertical-align:bottom;">
                                <div style="font-size:15px; font-weight:bold;">PO #{{ $purchase->id }}</div>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align:center; padding-top:30px;">
                    ...
                    <div style="border-top:1px solid #333; padding-top:4px;">Received By</div>
                </td>
            </tr>
