                                ...
                                <tbody>
                                    @forelse ($purchases as $index => $purchase)
                                        <tr>
                                            ...
                                            <td>
                                                {{ optional($purchase->deleted_at)->format('M d, Y h:i A') ?? 'N/A' }}
                                            </td>

                                            <td>
                                                <form action="{{ route('restore.purchase', $purchase->id) }}"
                                                    method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('PUT')

                                                    <button type="submit"
                                                        class="btn btn-sm btn-success restore-form"
                                                        data-item="Purchase">
                                                        Restore
                                                    </button>
                                                </form>
