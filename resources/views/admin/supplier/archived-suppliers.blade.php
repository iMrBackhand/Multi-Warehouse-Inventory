                ...
                <div class="text-end">
                    {{-- <button type="button" class="btn btn-sm" style="background-color: #6f42c1; color: #fff;" data-bs-toggle="modal" data-bs-target="#addSupplierModal">
                        + Add Supplier
                         ...
                         <a href="{{ route('suppliers') }}" class="btn btn-sm text-white" style="background-color:#6c757d;">
                                Back
                        </a>
                </div>
            </div>
                      ...
                      <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   <form action="{{ route('restore.supplier',$supplier->id) }}" method="POST" style="display: inline">
                                        @csrf
                                        @method('PUT')

                                        <button type="submit" class="btn btn-sm btn-success restore-form" id="restore-btn" data-item="Supplier">
                                            Restore
                                        </button>
                                    </form>
                                </td>
