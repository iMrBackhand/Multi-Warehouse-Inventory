                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold fs-16">{{ $sale->saleItems->count() }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold fs-16">{{ $sale->customer->customer_name ?? 'Walk-in Customer' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white d-flex align-items-center gap-2">
                            ...
                            <h5 class="mb-0 fs-15 fw-semibold">Sale Information</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <th class="text-muted fw-normal" width="45%">Sale ID</th>
                                        <td class="fw-semibold">#{{ $sale->id }}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-muted fw-normal">Sale Date</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark border">
                                                ...
                                                {{ $sale->due_amount > 0 ? 'Partial / Due' : 'Fully Paid' }}
                                            </span>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-warning">+ ₱ {{ number_format($sale->shipping, 2) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-semibold" style="color:#6f42c1;">₱ {{ number_format($sale->due_amount, 2) }}</td>
                                    </tr>
                                    <tr class="border-top">
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="mb-0 fs-15 fw-semibold">Sold Items</h5>
                            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                    @forelse($sale->saleItems as $key => $item)
                                        <tr>
        ...
        <table class="print-only" style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="vertical-align:bottom;">
                                ...
                                <div style="color:#666; font-size:12px;">Sales Invoice / Receipt</div>
                            </td>
                            <td style="text-align:right; vertical-align:bottom;">
                                <div style="font-size:15px; font-weight:bold;">SI #{{ $sale->id }}</div>
                ...
                <td colspan="5">
                    <table style="width:100%; border-collapse:collapse;">
                        <tr>
                            ...
                            <td style="width:25%; padding:4px 0; font-weight:600;">{{ $sale->customer->customer_name ?? 'Walk-in Customer' }}</td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:4px 0; font-weight:600;">{{ $sale->due_amount > 0 ? 'Partial / Due' : 'Fully Paid' }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table style="width:100%; border-collapse:collapse;">
                        ...
                        @forelse($sale->saleItems as $key => $item)
                            <tr>
                                ...
                                <td style="border:1px solid #333; padding:6px; text-align:right;">₱ {{ number_format($item->price, 2) }}</td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td style="border:1px solid #333; padding:6px; text-align:right;">− ₱ {{ number_format($sale->discount, 2) }}</td>
                            </tr>
                            <tr>
                                <td colspan="4" style="border:1px solid #333; padding:6px; text-align:right;">Shipping</td>
                                <td style="border:1px solid #333; padding:6px; text-align:right;">+ ₱ {{ number_format($sale->shipping, 2) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4" style="border:1px solid #333; padding:6px; text-align:right;">Remaianing Balance</td>
            ...
            <tr>
                <td colspan="2" style="text-align:center; padding-top:30px;">
                    <div style="font-weight:bold; margin-bottom:4px;">{{ $sale->customer->customer_name ?? 'Walk-in Customer' }}</div>
