            ...
            <div class="container-fluid my-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.return.sales',$sales->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <input
                                                    ...
                                                    name="sale_date"
                                                    class="form-control"
                                                    value="{{ old('purchase_date', \Carbon\Carbon::parse($sales->purchase_date)->format('Y-m-d')) }}">
                                                    ...
                                                    <div class="form-group w-100">
                                                        ...
                                                        <select name="warehouse_id" id="warehouse_id" class="form-control form-select">
                                                            ...
                                                            @foreach ($warehouses as $warehouse)
                                                                <option value="{{ $warehouse->id }}" {{ $sales->warehouse_id ==$warehouse->id ? 'selected' : ''}}>
                                                    ...
                                                    <div class="form-group w-100">
                                                        ...
                                                        <select name="customer_id" id="customer_id" class="form-control form-select">
                                                            ...
                                                            @foreach ($customers as $customer)
                                                                <option value="{{ $customer->id }}" {{ $sales->customer_id ==$customer->id ? 'selected' : ''}} >
                                    ...
                                    <div class="table-responsive">
                                        <table id="purchaseTable" class="table table-striped table-bordered w-100">
                                            <thead>
                                                ...
                                                <tbody>
                                            @forelse ($sales->saleReturnItems as $item)
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group w-100">
                                                        ...
                                                        <select name="status" id="status" class="form-control form-select" required>
                                                            ...
                                                            <option value="Pending"
                                                                {{ old('status', $sales->status) == 'Pending' ? 'selected' : '' }}>
                                                                Pending
                                                            </option>

                                                            <option value="Ordered"
                                                                {{ old('status', $sales->status) == 'Ordered' ? 'selected' : '' }}>
                                                                Ordered
                                                            </option>

                                                            <option value="return"
                                                                {{ old('status', $sales->status) == 'return' ? 'selected' : '' }}>
                                                                Return
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows="3"
                                                        class="form-control"
                                                        placeholder="Enter Notes">{{ $sales->note }}</textarea>
                                                </div>
