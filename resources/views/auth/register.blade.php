                                        ...
                                        <div class="pt-0">
                                            <form action="{{ route('register') }}" method="POST" class="my-4">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" name="name" type="text" id="name"  value="{{ old('name') }}"  placeholder="Enter your name">
                                                    @error('name')
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" name="password_confirmation" type="password" required="" id="password_confirmation"  placeholder="Confirm password">
